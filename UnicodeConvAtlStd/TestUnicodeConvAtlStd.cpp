////////////////////////////////////////////////////////////////////////////////
// TestUnicodeConvAtlStd.cpp : Test the Unicode conversion functions
// by Giovanni Dicanio <giovanni.dicanio AT gmail.com>
////////////////////////////////////////////////////////////////////////////////


#include "UnicodeConvAtlStd.hpp"     // Module to test
...
{
    CString utf16empty;
    std::string utf8empty = UnicodeConvAtlStd::ToUtf8(utf16empty);
    ATLASSERT(utf8empty.empty());
...
void TestStringsWithJapaneseKanji()
{
    ...
    CString utf16 = L"Japanese kanji \x5B66";
    std::string utf8 = UnicodeConvAtlStd::ToUtf8(utf16);
    CString utf16Again = UnicodeConvAtlStd::ToUtf16(utf8);
...
void TestStringLengths()
{
    ...
    CString utf16 = L"\x5B66";
    ATLASSERT(utf16.GetLength() == 1); // 1 wchar_t in UTF-16

    std::string utf8 = UnicodeConvAtlStd::ToUtf8(utf16);
    ATLASSERT(utf8.length() == 3); // 3 chars when encoded in UTF-8
    Check(utf8.length() == 3, "UTF-8 length");
    ATLASSERT(strlen(utf8.c_str()) == 3);
...
{
    std::cout << "*** Test Unicode UTF-16/UTF-8 CString/std::string Conversion Functions *** \n"
              << "    ================================================================== \n"
              << "    by Giovanni Dicanio \n\n";
